...
# 1. Append data to the tail of the list and prepend to the head
# 2. Search the linked list for a value and return the node
# 3. Remove a node
# 4. Pop, which means to return the first node's value and delete the node from the list
# 5. Insert data at some position in the list
# 6. Return the size (length) of the linked list
